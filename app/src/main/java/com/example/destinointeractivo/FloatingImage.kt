...
fun FloatingImage(
    ...
    durationMillis: Int = 100, // Duración total más rápida para alfa y tamaño
    onAnimationEnd: () -> Unit
) {
    var currentAlphaTarget by remember { mutableStateOf(1f) } // Comienza visible
    // El tamaño inicial (cuando aparece) es el normal
    ...
    LaunchedEffect(isCritical) {
        ...
        // Esto crea el efecto de "pop" de tamaño casi instantáneo
