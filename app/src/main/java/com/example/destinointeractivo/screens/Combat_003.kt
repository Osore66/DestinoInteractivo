...
fun Combat_003(
    ...
    val combatData = remember {
        CombatScreenData(
            enemyId = 3,
            backgroundMusicResId = R.raw.music_battlemusic_03,
            backgroundPainterResId = R.drawable.enemigofondo2,
            //enemyPainterResId = R.drawable.dragon2,
            enemyImageSize = 300.dp,
            startDialogueResId = R.string.combate_003,
            // --- Parámetros de navegación ---
            currentScreenRoute = AppScreens.Combat_003.route, // La ruta de esta pantalla
            nextScreenRouteOnWin = AppScreens.Combat_003_Victory.route, // La pantalla a la que ir al ganar este combate
